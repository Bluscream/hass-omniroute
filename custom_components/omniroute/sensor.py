...
GATEWAY_SENSORS: tuple[GatewaySensorDescription, ...] = (
    ...
    GatewaySensorDescription(
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda d: d.health_status,
        attr_fn=lambda d: {
            "version": d.version,
            "node_version": d.node_version,
            "active_connections": d.active_connections,
            "degradation_active": d.degradation_active,
            "degraded_features": d.degraded_features or None,
            "database_healthy": d.database_healthy,
            "database_issues": d.database_issues or None,
            "storage_driver": d.storage_driver,
            "last_backup": d.last_backup_at.isoformat() if d.last_backup_at else None,
        },
    ),
    GatewaySensorDescription(
        key="version",
        ...
        attr_fn=lambda d: {"node_version": d.node_version},
    ),
    GatewaySensorDescription(
        key="started",
        name="Started",
    ...
    GatewaySensorDescription(
        ...
        state_class=SensorStateClass.MEASUREMENT,
        entity_category=EntityCategory.DIAGNOSTIC,
        value_fn=lambda d: d.breakers_open,
        attr_fn=lambda d: {
            "half_open": d.breakers_half_open,
            "total": d.breakers_total,
            "states": d.breaker_states or None,
        },
    ),
    GatewaySensorDescription(
        ...
        value_fn=lambda d: d.active_connections,
    ),
    GatewaySensorDescription(
        key="memory",
        name="Memory used",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda d: d.memory_used,
        attr_fn=lambda d: {"rss_bytes": d.memory_rss},
    ),
    GatewaySensorDescription(
        key="storage",
        name="Database size",
        ...
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
        value_fn=lambda d: d.storage_bytes,
        attr_fn=lambda d: {
            "driver": d.storage_driver,
            "last_backup": d.last_backup_at.isoformat() if d.last_backup_at else None,
        },
    ),
    GatewaySensorDescription(
